...
@section('content')
    ...
    <div class="container">
        ...
        <div id="secondary" class="widget-area col-xs-12 col-md-3">
            ...
            <aside class="widget widget_color">
                <h3 class="widget-title">By Color</h3>
                <ul>
                    <li><i class="color1"></i><a href="#" title="Black">Blue</a></li>
                    <li><i class="color2"></i><a href="#" title="Brown">Brown</a></li>
                    <li><i class="color3"></i><a href="#" title="Gray">Gray</a></li>
                    <li><i class="color4"></i><a href="#" title="Green">Green</a></li>
                    <li><i class="color5"></i><a href="#" title="Orange">Orange</a></li>
                    <li><i class="color6"></i><a href="#" title="White">White</a></li>
                </ul>
            </aside>
